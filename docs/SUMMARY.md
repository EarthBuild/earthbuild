...
* [💻 Install EarthBuild](install/install.md)
* [🎓 Learn the basics](basics/basics.md)
    ...
    * [Part 6: Using Docker In EarthBuild](basics/part-6-using-docker-with-earthbuild.md)
    * [Part 7: Using EarthBuild in your current CI](basics/part-7-using-earthbuild-in-your-current-ci.md)
...
* Guides
    ...
    * [Using Docker in EarthBuild](guides/docker-in-earthbuild.md)
...
* [Earthfile reference](earthfile/earthfile.md)
    ...
    * [Excluding patterns](earthfile/earthbuildignore.md)
    * [Version-specific features](earthfile/features.md)
* [The `earthbuild` command](earthbuild-command/earthbuild-command.md)
...
* [Use the EarthBuild CI Image](ci-integration/use-earthbuild-ci-image.md)
* [Build your own EarthBuild CI Image](ci-integration/build-an-earthbuild-ci-image.md)
