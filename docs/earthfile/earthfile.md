...
Earth provides officially supported images such as `earthbuild/dind:alpine-3.24-docker-29.5.3-r1` and `earthbuild/dind:ubuntu-26.04-docker-29.8.1-1` to be used together with `WITH DOCKER`.
{% endhint %}
