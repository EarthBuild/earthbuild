...
- [🔀 Migrating from EarthBuild](migrating-from-earthly.md)
- [🎓 Learn the basics](basics/basics.md)
    ...
    - [Part 8a: Using EarthBuild in your current CI](basics/part-8a-using-earthly-in-your-current-ci.md)
...
- Guides
    ...
    - [Using Docker in EarthBuild](guides/docker-in-earthly.md)
...
- [The `earth` command](earthly-command/earthly-command.md)
...
- [Use the Earthbuild CI Image](ci-integration/use-earthly-ci-image.md)
- [Build your own Earthbuild CI Image](ci-integration/build-an-earthly-ci-image.md)
