...
//
// Falls back to the content size where a filesystem does not report blocks,
// which under-reports rather than refuses - the honest failure for a number
// used to decide how much to delete.
