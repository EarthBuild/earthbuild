...
- `+build`
- `./js+deps`
- `github.com/earthbuild/earthbuild:v0.8.17+earthly`
- `my-import+build`
...
- `./js+build/dist`
- `github.com/earthbuild/earthbuild:v0.8.17+earthbuild/earthbuild`
...
- `+COMPILE`
- `./js+NPM_INSTALL`
- `github.com/earthbuild/earthbuild:v0.8.17+DOWNLOAD_DIND`
- `my-import+COMPILE`
...
| `github.com/earthbuild/earthbuild:v0.8.17`                  | `github.com/earthbuild/earthbuild:v0.8.17+build`                          | `github.com/earthbuild/earthbuild:v0.8.17+build/out.bin`                                  | `github.com/earthbuild/earthbuild:v0.8.17+COMPILE`                          |
...
| `IMPORT github.com/earthbuild/earthbuild:v0.8.17`   | `earthly`        | `earthly+build`                | `earthly+build/out.bin`                        | `earthly+COMPILE`                |
