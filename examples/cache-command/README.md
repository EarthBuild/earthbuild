...
A simple solution is to delete the cache by running [`earth prune`](https://docs.earthbuild.dev/earth-command/earth-command#earth-prune).
...
Feel free to reach out via GitHub Issue or on our [Community Slack channel](https://earthly.dev/slack) if you have any questions or ideas. Thanks for using EarthBuild!
