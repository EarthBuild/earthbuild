...
func TestGetProjectName(t *testing.T) {
	var tests = []struct {
		...
		{"http://github.com/EarthBuild/earthbuild/subdir/anothersubdir", "earthly/earthly/subdir/anothersubdir"},
		{"http://gitlab.com/earthly/earthly/subdir/anothersubdir", "earthly/earthly/subdir/anothersubdir"},
		{"https://github.com/EarthBuild/earthbuild/subdir/anothersubdir", "earthly/earthly/subdir/anothersubdir"},
		{"https://user@github.com/EarthBuild/earthbuild/subdir/anothersubdir", "earthly/earthly/subdir/anothersubdir"},
		{"https://user:password@github.com/EarthBuild/earthbuild/subdir/anothersubdir", "earthly/earthly/subdir/anothersubdir"},
		...
		{"ssh://git@github.com/EarthBuild/earthbuild/subdir/anothersubdir", "earthly/earthly/subdir/anothersubdir"},
