...
Earthly provides officially supported images such as `earthbuild/dind:alpine-3.20-docker-26.1.5-r0` and `earthbuild/dind:ubuntu-23.04-docker-25.0.2-1` to be used together with `WITH DOCKER`.
{% endhint %}
