	...
	return []*cli.Command{
		{
			...
			Subcommands: []*cli.Command{
				...
				},
				{
					...
					UsageText:   "earth [options] debug buildkit-info",
				...
				},
				{
					...
					UsageText:   "earth [options] debug buildkit-disk-usage",
				...
				},
				{
					...
					UsageText:   "earth [options] debug buildkit-workers",
				...
				},
				{
					...
					UsageText:   "earth [options] debug buildkit-shutdown-if-idle",
				...
				},
				{
					...
					UsageText:   "earth [options] debug buildkit-session-history",
...
func (a *Debug) actionBuildkitWorkers(cliCtx *cli.Context) error {
	...
	for _, info := range workers {
		...
		if info.GCAnalytics.CurrentStartTime != nil {
			...
			fmt.Printf("\tGC Current size before: %s\n", humanizeBytes(info.GCAnalytics.CurrentSizeBefore))
		} else {
		...
		if info.GCAnalytics.LastStartTime != nil {
			...
			fmt.Printf("\tGC Last size cleared: %s\n", humanizeBytes(info.GCAnalytics.LastSizeCleared))
