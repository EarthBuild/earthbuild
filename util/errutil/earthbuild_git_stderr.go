...
const earthbuildGitStdErrMagicString = "earthbuild_GIT_STDERR"

var gitStdErrRegexp = regexp.MustCompile(`earthbuild_GIT_STDERR: ([A-Za-z0-9+/]*={0,2}):`)

// ExtractearthbuildGitStdErr scans an error string for a base64 payload that contains the git stderr
...
func ExtractearthbuildGitStdErr(errStr string) (extracted, shorterErr string, ok bool) {
