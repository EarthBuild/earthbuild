...
- `+build`
- `./js+deps`
- `github.com/earthbuild/earthbuild:v0.8.19+earthly`
- `my-import+build`
...
- `./js+build/dist`
- `github.com/earthbuild/earthbuild:v0.8.19+earthbuild/earthbuild`
...
- `+COMPILE`
- `./js+NPM_INSTALL`
- `github.com/earthbuild/earthbuild:v0.8.19+DOWNLOAD_DIND`
- `my-import+COMPILE`
...
| `github.com/earthbuild/earthbuild:v0.8.19`                  | `github.com/earthbuild/earthbuild:v0.8.19+build`                          | `github.com/earthbuild/earthbuild:v0.8.19+build/out.bin`                                  | `github.com/earthbuild/earthbuild:v0.8.19+COMPILE`                          |
...
| `IMPORT github.com/earthbuild/earthbuild:v0.8.19`   | `earthbuild`     | `earthbuild+build`             | `earthbuild+build/out.bin`                     | `earthbuild+COMPILE`             |
