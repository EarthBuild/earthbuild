...
| `--earthly-version-arg`                 | 0.7                                                                             | Enables builtin ARGs: `EARTH_VERSION` and `EARTH_BUILD_SHA`                                                       |
...
| `--earthly-locally-arg`                 | 0.7                                                                             | Enable the `EARTH_LOCALLY` arg                                                                                    |
| `--use-project-secrets`                 | 0.7                                                                             | Enable project-based secret resolution                                                                            |
| `--earthly-git-author-args`             | 0.7                                                                             | Enable the `EARTH_GIT_AUTHOR` and `EARTH_GIT_CO_AUTHORS` args                                                     |
...
| `--earthly-ci-runner-arg`               | Experimental                                                                    | Enable the `EARTH_CI_RUNNER` builtin ARG                                                                          |
