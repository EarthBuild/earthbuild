			...
			Subcommands: []*cli.Command{
				{
					...
					UsageText:   "earthbuild [options] debug ast",
				...
				},
				{
					...
					UsageText:   "earthbuild [options] debug buildkit-info",
				...
				},
				{
					...
					UsageText:   "earthbuild [options] debug buildkit-disk-usage",
				...
				},
				{
					...
					UsageText:   "earthbuild [options] debug buildkit-workers",
				...
				},
				{
					...
					UsageText:   "earthbuild [options] debug buildkit-shutdown-if-idle",
				...
				},
				{
					...
					UsageText:   "earthbuild [options] debug buildkit-session-history",
