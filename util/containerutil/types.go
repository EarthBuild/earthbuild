...
const (
	...
	// FrontendStub is for when there is no valid provider but attempting to run anyways is desired; like integration tests, or the earthbuild/earthbuild image when NO_DOCKER is set.
	FrontendStub = "stub"
)
